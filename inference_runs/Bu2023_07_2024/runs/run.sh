...
### User settings here:
export prior_filename=AT2017gfo_dL40_tight_iota # choose prior, also used as label
...
mpiexec -np 16 lightcurve-analysis \
    --model Bu2023Ye \
    --svd-path /home/urash/twouters/new_nmma_models/retrained_shreya/svdmodels_Bu2023Ye_newheat \
    --outdir "./outdir/" \
    --label $label \
